...
export const BOARD_MODELS: Record<string, BoardModelConfig> = {
  princess: {
    ...
    outlineOptions: [
      ...
      { label: 'Roundpin', price_cents: 45000, preview_image: '/photos/models/princess/princess-roundpin-new.jpg', outline_image: '/photos/models/princess/outline-roundpin.png' },
    ],
    measures: [
  ...
  gentleman: {
    ...
    outlineOptions: [
      ...
      },
      {
        ...
        outline_image: '/photos/models/gentleman/outline-bump-squash-new.jpg',
      },
      {
        label: 'Squash',
        price_cents: 45000,
