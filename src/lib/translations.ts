...
export const translations = {
    ...
    en: {
        ...
        sobre_historia_p3: 'What began as curiosity became obsession. I needed to understand why some boards danced in the water and others simply floated. Why certain rail lines made the board go slower or faster. Why a centimetre could be the difference between magic and mediocrity.',
