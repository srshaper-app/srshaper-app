...
const MODELS: Record<string, ModelInfo> = {
  ...
  'gentleman': {
    ...
    longDescription:
      'Tabla corta de alto rendimiento diseñada para olas medianas y grandes con un rocker de entrada pronunciado que facilita la maniobrabilidad, single cóncavo central terminado en V y un squash tail que aporta estabilidad y control. Con su porte elegante, este distinguido Caballero será el mejor aliado que puedas tener en tu equipo.',
    manufacturingMeasures: [
      `5'5" x 19" x 2 1/1" Wider squash`,
      `5'7" x 18.5" x 2 1/2" Bump squash`,
      `5'8" x 18" x 2 3/8" Squash`,
      `5'8" x 19.5" x 2 3/8" Wider squash`,
      `5'10" x 19" x 2 3/8" Bump squash`,
      `5'11" x 18.5" x 2 3/8" Squash`,
      `5'11" x 20" x 2 Wider squash`,
